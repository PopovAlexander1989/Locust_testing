...
class PurchaseFlightTicket(SequentialTaskSet): # класс с задачами (содержит основной сценарий)
    ...
    def on_start(self) -> None:
        ...
        def uc01_01_getLogin(self) -> None:
            ...
            self.client.get(
                ...
                name='REQ01_02_2_/nav.pl?page=menu&in=home',
                headers={
                    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
                    'accept-encoding': 'gzip, deflate, br, zstd'
                },
    ...
    def uc01_04_findFlight(self):
        ...
        req_body_04_01 = f'advanceDiscount=0&depart={self.depart}&departDate={date_list["depart_date"]}&arrive={self.arrive}&returnDate={date_list["arrive_date"]}&numPassengers=1&seatPref={self.seatPref}&seatType={self.seatType}&findFlights.x=35&findFlights.y=13&.cgifields=roundtrip&.cgifields=seatType&.cgifields=seatPref'
    ...
    def uc01_05_choiceFlight(self):
        ...
        req_body_05_01 = f'outboundFlight={unquote_plus(self.outboundFlight)}&numPassengers=1&advanceDiscount=0&seatType={self.seatType}&seatPref={self.seatPref}&reserveFlights.x=61&reserveFlights.y=7'
